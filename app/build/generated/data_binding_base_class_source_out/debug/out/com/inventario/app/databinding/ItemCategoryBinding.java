...
public final class ItemCategoryBinding implements ViewBinding {
  ...
  private ItemCategoryBinding(@NonNull CardView rootView, @NonNull View categoryColor,
  ...
  public static ItemCategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      View categoryColor = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ItemCategoryBinding((CardView) rootView, categoryColor, categoryName);
    }
